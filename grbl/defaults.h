...
/* The defaults.h file serves as a central default settings selector for different machine
...
#ifdef DEFAULTS_TIMSAV_PLUS
  // Defaults for the TimSav+ needle cutter and CNC machine.
  #define DEFAULT_X_STEPS_PER_MM 20.0
  #define DEFAULT_Y_STEPS_PER_MM 20.0
  #define DEFAULT_Z_STEPS_PER_MM 60.0
  ...
  #define DEFAULT_X_MAX_TRAVEL 520.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 770.0 // mm NOTE: Must be a positive value.
